...
public class ChatAppIdCheckerUI : MonoBehaviour
{
    ...
    public void Update()
    {
		if (string.IsNullOrEmpty(PhotonNetwork.PhotonServerSettings.AppSettings.AppIdChat))
        {
            ...
            {
                Description.text =
                    "<Color=Red>WARNING:</Color> Please setup a Chat AppId in the PhotonServerSettings file.";
                Debug.LogError("<Color=Red>WARNING:</Color> Please setup a Chat AppId in the PhotonServerSettings file.");
            }
        }
        else
        {
